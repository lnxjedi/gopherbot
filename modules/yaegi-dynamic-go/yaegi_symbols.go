...
func init() {
	Symbols["github.com/lnxjedi/gopherbot/robot/robot"] = map[string]reflect.Value{
		...
		"InvalidCfgStruct":   reflect.ValueOf(robot.InvalidCfgStruct),
		"InvalidDatumKey":    reflect.ValueOf(robot.InvalidDatumKey),
		"InvalidDblPtr":      reflect.ValueOf(robot.InvalidDblPtr),
...
func (W _github_com_lnxjedi_gopherbot_robot_Connector) SetUserMap(a0 map[string]string) {
	W.WSetUserMap(a0)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Robot) GetTaskConfig(dptr interface{}) robot.RetVal {
	return W.WGetTaskConfig(dptr)
}
