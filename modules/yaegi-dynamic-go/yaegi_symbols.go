...
func (W _github_com_lnxjedi_gopherbot_robot_Connector) JoinChannel(c string) robot.RetVal {
	return W.WJoinChannel(c)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Handler) GetConfigPath() string {
	return W.WGetConfigPath()
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) GetDirectory(path string) error {
	return W.WGetDirectory(path)
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) GetEventStrings() *[]string {
	return W.WGetEventStrings()
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) GetHistoryConfig(a0 interface{}) error {
	return W.WGetHistoryConfig(a0)
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) GetInstallPath() string {
	return W.WGetInstallPath()
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) GetLogLevel() robot.LogLevel {
	return W.WGetLogLevel()
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) GetProtocolConfig(a0 interface{}) error {
	return W.WGetProtocolConfig(a0)
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) IncomingMessage(a0 *robot.ConnectorMessage) {
	W.WIncomingMessage(a0)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Handler) SetBotMention(mention string) {
	W.WSetBotMention(mention)
}
func (W _github_com_lnxjedi_gopherbot_robot_Handler) SetTerminalWriter(a0 io.Writer) {
	W.WSetTerminalWriter(a0)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_HistoryLogger) Close() {
	W.WClose()
}
func (W _github_com_lnxjedi_gopherbot_robot_HistoryLogger) Finalize() {
	W.WFinalize()
}
func (W _github_com_lnxjedi_gopherbot_robot_HistoryLogger) Line(line string) {
	W.WLine(line)
}
func (W _github_com_lnxjedi_gopherbot_robot_HistoryLogger) Log(line string) {
	W.WLog(line)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_HistoryProvider) GetLog(tag string, index int) (io.Reader, error) {
	return W.WGetLog(tag, index)
}
func (W _github_com_lnxjedi_gopherbot_robot_HistoryProvider) GetLogURL(tag string, index int) (URL string, exists bool) {
	return W.WGetLogURL(tag, index)
}
func (W _github_com_lnxjedi_gopherbot_robot_HistoryProvider) MakeLogURL(tag string, index int) (URL string, exists bool) {
	return W.WMakeLogURL(tag, index)
}
func (W _github_com_lnxjedi_gopherbot_robot_HistoryProvider) NewLog(tag string, index int, maxHistories int) (robot.HistoryLogger, error) {
	return W.WNewLog(tag, index, maxHistories)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Logger) Log(l robot.LogLevel, m string, v ...interface{}) {
	W.WLog(l, m, v...)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Robot) AddCommand(a0 string, a1 string) robot.RetVal {
	return W.WAddCommand(a0, a1)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) AddJob(a0 string, a1 ...string) robot.RetVal {
	return W.WAddJob(a0, a1...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) AddTask(a0 string, a1 ...string) robot.RetVal {
	return W.WAddTask(a0, a1...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) CheckAdmin() bool {
	return W.WCheckAdmin()
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Subscribe() bool {
	return W.WSubscribe()
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Unsubscribe() bool {
	return W.WUnsubscribe()
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) CheckinDatum(key string, locktoken string) {
	W.WCheckinDatum(key, locktoken)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) CheckoutDatum(key string, datum interface{}, rw bool) (locktoken string, exists bool, ret robot.RetVal) {
	return W.WCheckoutDatum(key, datum, rw)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Direct() robot.Robot {
	return W.WDirect()
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Elevate(a0 bool) bool {
	return W.WElevate(a0)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Email(subject string, messageBody *bytes.Buffer, html ...bool) (ret robot.RetVal) {
	return W.WEmail(subject, messageBody, html...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) EmailAddress(address string, subject string, messageBody *bytes.Buffer, html ...bool) (ret robot.RetVal) {
	return W.WEmailAddress(address, subject, messageBody, html...)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Robot) FailCommand(a0 string, a1 string) robot.RetVal {
	return W.WFailCommand(a0, a1)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) FailTask(a0 string, a1 ...string) robot.RetVal {
	return W.WFailTask(a0, a1...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) FinalCommand(a0 string, a1 string) robot.RetVal {
	return W.WFinalCommand(a0, a1)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) FinalTask(a0 string, a1 ...string) robot.RetVal {
	return W.WFinalTask(a0, a1...)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Robot) GetHelpMetadata(query string) string {
	return W.WGetHelpMetadata(query)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) GetMessage() *robot.Message {
...
func (W _github_com_lnxjedi_gopherbot_robot_Robot) GetTaskConfig(cfgptr interface{}) robot.RetVal {
	return W.WGetTaskConfig(cfgptr)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) GetUserAttribute(u string, a string) *robot.AttrRet {
	return W.WGetUserAttribute(u, a)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Pause(s float64) {
	W.WPause(s)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) PromptForReply(regexID string, prompt string, v ...interface{}) (string, robot.RetVal) {
	return W.WPromptForReply(regexID, prompt, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) PromptThreadForReply(regexID string, prompt string, v ...interface{}) (string, robot.RetVal) {
	return W.WPromptThreadForReply(regexID, prompt, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) PromptUserChannelForReply(regexID string, user string, channel string, prompt string, v ...interface{}) (string, robot.RetVal) {
	return W.WPromptUserChannelForReply(regexID, user, channel, prompt, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) PromptUserChannelThreadForReply(regexID string, user string, channel string, thread string, prompt string, v ...interface{}) (string, robot.RetVal) {
	return W.WPromptUserChannelThreadForReply(regexID, user, channel, thread, prompt, v...)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_Robot) RandomString(s []string) string {
	return W.WRandomString(s)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Recall(key string, shared bool) string {
	return W.WRecall(key, shared)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) DeleteMemory(key string, shared bool) {
	W.WDeleteMemory(key, shared)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) DeleteDatum(key string) (ret robot.RetVal) {
	return W.WDeleteDatum(key)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Remember(key string, value string, shared bool) {
	W.WRemember(key, value, shared)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) RememberContext(context string, value string) {
	W.WRememberContext(context, value)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) RememberContextThread(context string, value string) {
	W.WRememberContextThread(context, value)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) RememberThread(key string, value string, shared bool) {
	W.WRememberThread(key, value, shared)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Reply(msg string, v ...interface{}) robot.RetVal {
	return W.WReply(msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) ReplyThread(msg string, v ...interface{}) robot.RetVal {
	return W.WReplyThread(msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) Say(msg string, v ...interface{}) robot.RetVal {
	return W.WSay(msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SayThread(msg string, v ...interface{}) robot.RetVal {
	return W.WSayThread(msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SendChannelMessage(ch string, msg string, v ...interface{}) robot.RetVal {
	return W.WSendChannelMessage(ch, msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SendChannelThreadMessage(ch string, thr string, msg string, v ...interface{}) robot.RetVal {
	return W.WSendChannelThreadMessage(ch, thr, msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SendProtocolUserChannelMessage(protocol string, u string, ch string, msg string, v ...interface{}) robot.RetVal {
	return W.WSendProtocolUserChannelMessage(protocol, u, ch, msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SendUserChannelMessage(u string, ch string, msg string, v ...interface{}) robot.RetVal {
	return W.WSendUserChannelMessage(u, ch, msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SendUserChannelThreadMessage(u string, ch string, thr string, msg string, v ...interface{}) robot.RetVal {
	return W.WSendUserChannelThreadMessage(u, ch, thr, msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SendUserMessage(u string, msg string, v ...interface{}) robot.RetVal {
	return W.WSendUserMessage(u, msg, v...)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SetParameter(a0 string, a1 string) bool {
	return W.WSetParameter(a0, a1)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SetWorkingDirectory(a0 string) bool {
	return W.WSetWorkingDirectory(a0)
}
func (W _github_com_lnxjedi_gopherbot_robot_Robot) SpawnJob(a0 string, a1 ...string) robot.RetVal {
	return W.WSpawnJob(a0, a1...)
}
...
func (W _github_com_lnxjedi_gopherbot_robot_SimpleBrain) Delete(key string) error {
	return W.WDelete(key)
}
func (W _github_com_lnxjedi_gopherbot_robot_SimpleBrain) List() (keys []string, err error) {
	return W.WList()
}
func (W _github_com_lnxjedi_gopherbot_robot_SimpleBrain) Retrieve(key string) (blob *[]byte, exists bool, err error) {
	return W.WRetrieve(key)
}
func (W _github_com_lnxjedi_gopherbot_robot_SimpleBrain) Store(key string, blob *[]byte) error {
	return W.WStore(key, blob)
}
