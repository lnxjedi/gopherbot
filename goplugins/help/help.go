...
func buildHelpReply(botName, botAlias, botContact, protocol string) string {
	...
	lines = append(lines,
		...
		"- "+preferredCommandExample(botName, botAlias, "commands")+" - browse commands available in this channel",
		"- "+preferredCommandExample(botName, botAlias, "help <keyword>")+" - show the best matching commands",
		"- "+preferredCommandExample(botName, botAlias, "help-all")+" - one-line summaries for all commands available here",
		"",
		"Most browse and search results are terse, one-line summaries. For full usage, options, examples, and availability for one command, use "+preferredCommandExample(botName, botAlias, "help <plugin>/<command>")+".",
		"",
