// Package main implements a lists demonstrator plugin showing how you
...
- Command: 'add'
  ...
  Usage: "add <item> to the <type> list"
...
- Command: 'remove'
  ...
  Usage: "remove <item> from the <type> list"
...
- Command: 'pick'
  ...
  Usage: "pick a random item from the <type> list"
