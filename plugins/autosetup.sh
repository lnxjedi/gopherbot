...
then
    Say "NOTE: The setup plugin is deprecated and will be removed at a later date. \
Instead you should use 'gopherbot --init <protocol>' e.g. 'gopherbot --init slack', \
then edit 'answerfile.txt' and follow the instructions to set up your robot. Press \
<ctrl-d> to exit and use the new-style setup."
