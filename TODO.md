...
## BasicMarkdown Rendering
(In progress) - standardized outgoing message formatter.

### AI Formatting
The new AI plugin should translate incoming text from the AI to BasicMarkdown.
