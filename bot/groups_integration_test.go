...
func TestGroupAuth(t *testing.T) {
	...
	tests := []testItem{
		...
		{bob, general, ";remember Lieutenant Dan", []testc.TestMessage{{null, general, "Ok, .*"}}, []Event{GoPluginRan, AdminCheckFailed, AuthRanSuccess, CommandPluginRan, ScriptTaskRan}, 0},
		...
		{carol, general, ";remember Forest Gump", []testc.TestMessage{{null, general, "Ok, I'll remember .*"}}, []Event{GoPluginRan, AdminCheckFailed, AuthRanSuccess, CommandPluginRan, ScriptTaskRan}, 0},
		...
		{david, general, ";remember Jenny", []testc.TestMessage{{null, general, "Ok, I'll remember .*"}}, []Event{GoPluginRan, AdminCheckFailed, AuthRanSuccess, CommandPluginRan, ScriptTaskRan}, 0},
	}
