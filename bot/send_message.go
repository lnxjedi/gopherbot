...
// a specific user in a specific channel without fiddling with the robot object.
// This will fail with UserNotFound if the connector can't resolve the username.
