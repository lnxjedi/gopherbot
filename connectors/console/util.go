...
func (s *termConnector) getUser(u string) (user slack.User, ok bool) {
	s.RLock()
...
func (s *termConnector) userID(u string) (i string, ok bool) {
	s.RLock()
	user, ok := s.userInfo[u]
	s.RUnlock()
	if !ok {
...
func (s *termConnector) userName(i string) (u string, ok bool) {
	s.RLock()
	u, ok = s.idToUser[i]
	s.RUnlock()
	return u, ok
...
func (s *termConnector) userIMID(u string) (i string, ok bool) {
	s.RLock()
	i, ok = s.userIDToIM[u]
	s.RUnlock()
	return i, ok
...
func (s *termConnector) chanID(c string) (i string, ok bool) {
	s.RLock()
...
func (s *termConnector) channelName(i string) (c string, ok bool) {
	s.RLock()
...
func (s *termConnector) imUser(c string) (u string, ok bool) {
	s.RLock()
	u, ok = s.imToUser[c]
	s.RUnlock()
	return u, ok
...
func (s *termConnector) slackifyMessage(msg string, f bot.MessageFormat) []string {
...
func (s *termConnector) processMessage(msg *slack.MessageEvent) {
...
func (s *termConnector) updateMaps() {
