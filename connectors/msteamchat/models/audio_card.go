...
// AudioCard A audio card
// swagger:model AudioCard
...
func (m *AudioCard) validateButtons(formats strfmt.Registry) error {
...
func (m *AudioCard) validateImage(formats strfmt.Registry) error {
...
func (m *AudioCard) validateMedia(formats strfmt.Registry) error {
