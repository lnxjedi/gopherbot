...
func (m *HeroCard) validateButtons(formats strfmt.Registry) error {
...
func (m *HeroCard) validateImages(formats strfmt.Registry) error {
...
func (m *HeroCard) validateTap(formats strfmt.Registry) error {
