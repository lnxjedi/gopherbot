...
// VideoCard A video card
// swagger:model VideoCard
...
func (m *VideoCard) validateButtons(formats strfmt.Registry) error {
...
func (m *VideoCard) validateImage(formats strfmt.Registry) error {
...
func (m *VideoCard) validateMedia(formats strfmt.Registry) error {
