...
* Connectors previously had a `FormatHelp` method for protocol-specific help line styling; in v3, built-in help is rendered in engine-owned `BasicMarkdown` instead.
