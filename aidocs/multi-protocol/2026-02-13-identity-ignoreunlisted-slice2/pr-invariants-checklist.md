...
- PR slice: `identity-ignoreunlisted-slice2`
- Linked impact report: `aidocs/multi-protocol/2026-02-13-identity-ignoreunlisted-slice2/impact-surface-report.md`
...
- Focused tests added/updated: yes (`bot/handler_identity_test.go`)
...
- Residual risks:
  - global fallback `maps.userID` remains for compatibility username resolution and may still resolve names across protocols when protocol mapping is missing.
- Follow-up items:
  - remove global fallback identity maps after migration window.
