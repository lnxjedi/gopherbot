...
- PR slice: `execution-model-slice3`
- Linked impact report: `aidocs/multiprocess/2026-02-14-execution-model-slice3/impact-surface-report.md`
...
- Residual risks:
  - Interpreter-backed external task execution remains in-process.
- Follow-up items:
  - Define per-pipeline working-directory semantics for process-isolated children.
  - Plan interpreter-backed external task isolation strategy.
