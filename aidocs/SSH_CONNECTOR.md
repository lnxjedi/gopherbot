...
- Live SSH display expands tab characters to spaces at 4-column tab stops before wrapping/writing, with tab stops computed from the rendered column since the last newline. This keeps output independent of terminal emulator tab-stop defaults.
