...
content type is JSON and exposed as native JavaScript objects and arrays. HTTP
4xx/5xx responses are returned normally; callers must inspect
`ok`/`statusCode`. Transport, URL, and timeout failures throw.
