...
### HTTP / remote APIs
- [x] `require("http")` – `get`, `delete`, `head`, `patch`, `post`, `put`, `request`, and batch request helpers.
- [x] Automatic JSON request body encoding and response `json` property for JSON content types.
